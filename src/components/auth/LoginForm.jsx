      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="flex justify-center">
          <button
            ...
            disabled={loading}
            className="inline-flex items-center justify-center w-80 h-12 px-6 py-3 text-base font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-150"
          >
