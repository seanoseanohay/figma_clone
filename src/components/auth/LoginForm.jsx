      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="flex justify-center">
          <button
            ...
            disabled={loading}
            className="inline-flex items-center justify-center w-72 h-10 px-4 py-2 border border-gray-300 rounded text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-150 shadow-sm"
          >
