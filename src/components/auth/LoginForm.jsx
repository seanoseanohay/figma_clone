      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="flex justify-center">
          <button
            ...
            disabled={loading}
            className="inline-flex items-center justify-center w-full max-w-sm px-6 py-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none transition-colors duration-150"
          >
