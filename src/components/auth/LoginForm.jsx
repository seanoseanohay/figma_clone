      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="flex justify-center">
          <button
            ...
            disabled={loading}
            className="group relative w-full max-w-sm flex justify-center py-4 px-6 border-2 border-gray-300 text-base font-semibold rounded-lg text-gray-700 bg-white hover:bg-gray-50 hover:border-blue-300 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-25 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm hover:shadow-md"
          >
